        ...
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          ...
          <div class="order-3 xl:order-2">
            ...
            >
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">{{ 'Last Login: ' + userLastLogin }}</p>
            </div>
          </div>
...
const userRole = computed(() => {
  ...
  return user.value?.roles || 'Team Member'
})

const userLastLogin = computed(() => {
  return user.value?.lastLoginAt || 'Last login not set'
})
